...
class TestWebsiteFixtures(unittest.TestCase):
    ...
    def test_building_schema_fixture_files_cover_live_portal_fields(self):
        ...
        self.assertNotIn("key_storage_location", base_field_names)
        ...
        self.assertIn("company", custom_field_names)
        self.assertIn("billing_model", custom_field_names)
        self.assertIn("contract_amount", custom_field_names)
        self.assertIn("billing_interval", custom_field_names)
        self.assertIn("billing_interval_count", custom_field_names)
        self.assertIn("contract_start_date", custom_field_names)
        self.assertIn("contract_end_date", custom_field_names)
        self.assertIn("auto_renew", custom_field_names)
        self.assertIn("project", custom_field_names)
        self.assertIn("cost_center", custom_field_names)
        self.assertIn("subscription_plan", custom_field_names)
        self.assertIn("subscription", custom_field_names)
        self.assertIn("sales_order", custom_field_names)
        self.assertIn("contract", custom_field_names)
